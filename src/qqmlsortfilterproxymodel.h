                                 ...
                                 public ProxyRoleContainer
{
    ...
    Q_INTERFACES(SFPM_NAMESPACE::SorterContainer)
    Q_INTERFACES(SFPM_NAMESPACE::ProxyRoleContainer)
    ...
    Q_PROPERTY(QQmlListProperty<SFPM_NAMESPACE::Sorter> sorters READ sortersListProperty)
    Q_PROPERTY(QQmlListProperty<SFPM_NAMESPACE::ProxyRole> proxyRoles READ proxyRolesListProperty)
